...
#' applications!
#'
#' The data contain 831 rows and 9 variables:
#' \describe{
...
#' 
#' NOTE: This formatted dataset comes from the `openintro` 
#' package and has been duplicated here for practical 
#' reasons. Please note that full copyright resides 
#' with the maintainers of `openintro`. 
#' 
#' @keywords datasets
#' @name loans
#' @docType data
