...
#'
#' @examples
#' descriptives(bootcamp::movie)
#' descriptives(bootcamp::movie, digits = 3)
#' 
#' result <- descriptives(bootcamp::movie, print = FALSE)
#' print(result)
#' 
#' descriptives(bootcamp::movie, quantiles = c(.1, .9), IQR = TRUE)
